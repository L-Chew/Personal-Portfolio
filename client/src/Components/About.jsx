...
const About = () => {
  ...
  return (
    <div id='about' className='animate-fadeIn flex flex-col gap-4 md:gap-8 px-2'>
      ...
      <div className='flex items-center justify-evenly gap-4'>
        ...
        <div className='relative'>
          <img src={profilePic} alt='profilePic' className='w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-32 lg:h-32 xl:w-96 xl:h-96 object-cover rounded-full'></img>
