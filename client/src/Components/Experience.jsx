  ...
  return (
    <div id='experience'>
      ...
      <div>
        ...
        <div className='mt-12'>
          <a className='in-line-flex items-center font-semibold sm:text-md md:text-lg lg:text-xl xl:text-2xl' href='/resume.pdf' target='_blank' rel='noopener noreferrer'>View Full Résumé</a>
        </div>
      </div>
    </div>
  )
